package com.vald3nir.shoppinglist.domain.mocks
...
object MockShoppingListDTO {
    ...
    val items: List<ItemShoppingListDTO> = listOf(
        ItemShoppingListDTO(id = 0, title = "Arroz", unitPrice = 5.8, quantity = 2, isAdd = true, shoppingListId = 0),
        ItemShoppingListDTO(id = 1, title = "Feijão", unitPrice = 4.0, quantity = 0, isAdd = false, shoppingListId = 0),
        ItemShoppingListDTO(id = 2, title = "Óleo", unitPrice = 10.0, quantity = 3, isAdd = true, shoppingListId = 0),
        ItemShoppingListDTO(id = 3, title = "Açúcar", unitPrice = 4.8, quantity = 5, isAdd = false, shoppingListId = 0),
        ItemShoppingListDTO(id = 4, title = "Sal", unitPrice = 0.90, quantity = 1, isAdd = false, shoppingListId = 0),
        ItemShoppingListDTO(id = 5, title = "Café", unitPrice = 15.0, quantity = 4, isAdd = true, shoppingListId = 0),
        ItemShoppingListDTO(id = 6, title = "Leite", unitPrice = 5.99, quantity = 2, isAdd = false, shoppingListId = 0),
        ItemShoppingListDTO(id = 7, title = "Queijo", unitPrice = 10.0, quantity = 3, isAdd = false, shoppingListId = 0),
        ItemShoppingListDTO(id = 8, title = "Presunto", unitPrice = 6.0, quantity = 1, isAdd = false, shoppingListId = 0),
        ItemShoppingListDTO(id = 9, title = "Frango", unitPrice = 12.0, quantity = 1, isAdd = false, shoppingListId = 0),
    )
