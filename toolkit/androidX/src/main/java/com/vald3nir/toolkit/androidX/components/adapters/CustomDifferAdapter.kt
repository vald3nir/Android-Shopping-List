package com.vald3nir.toolkit.androidX.components.adapters
...
class CustomDifferAdapter<Item, Binding : ViewBinding>(
    private val bindingInflater: (LayoutInflater, ViewGroup, Boolean) -> Binding,
    private var list: Collection<Item>,
    itemDiffUtil: DiffUtil.ItemCallback<Item>,
    private val onBind: (Item, Binding, Int, CustomDifferAdapter<Item, Binding>) -> Unit
) : ListAdapter<Item, CustomDifferAdapter<Item, Binding>.ViewHolder>(itemDiffUtil) {
    ...
    inner class ViewHolder(
        ...
        private val genericAdapter: CustomDifferAdapter<Item, Binding>
